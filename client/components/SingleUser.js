...
class SingleUser extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div class="container" style={{ fontFamily: "dosis" }}>
        <div class="main-body">
          <nav aria-label="breadcrumb" class="main-breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
                <a href={`/account/orders/${id}`}>Orders</a>
              </li>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      <h4>{email}</h4>
                      <p class="text-secondary mb-1">Proud Owner</p>
                ...
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <div class="progress mb-3" style={{ height: 5 + "px" }}>
                        <div
